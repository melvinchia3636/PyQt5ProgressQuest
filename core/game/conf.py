...
var.get('K').put('状态', var.get('K').get('PrimeStats').callprop('slice', Js(0.0)).callprop('concat', Js([Js('HP Max'), Js('MP Max')])))
var.get('K').put('装备', Js([Js('武器'), Js('Shield'), Js('Helm'), Js('Hauberk'), Js('Brassairts'), Js('Vambraces'), Js('Gauntlets'), Js('Gambeson'), Js('Cuisses'), Js('Greaves'), Js('Sollerets')]))
