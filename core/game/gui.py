...
class Gui:
    ...
    def setWidgetsText(self):
        ...
        self.charSheetLabel.setText("角色面板")
        self.equipmentLabel.setText("装备")
        self.plotDevLabel.setText("剧情发展")
        self.ExpLabel.setText("经验值")
        self.spellLabel.setText("法术书")
        self.invLabel.setText("背包")
        self.encumbranceLabel.setText("负重")
        self.questsLabel.setText("任务列表")
